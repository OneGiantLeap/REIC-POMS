...
('000001','Aluminum Wire Bonders','Gold and aluminum wire bonding',100,35,135,1,'g','2016-04-18 00:00:00','2017-04-08 00:00:00',1),
('000002','Vacuum Sealer','A device or substance used to seal something',100,25,125,2,'g','2016-04-18 00:00:00','2017-04-18 00:00:00',1),
('000003','Paper Tapes','Holds data as patterns of punched holes',1234.75,15,1419.96,2,'g','2015-06-30 00:00:00','2016-06-30 00:00:00',2),
('000004','Extruded Magazine','Type of magazine',501,15,576.15,3,'lb','2015-11-21 00:00:00','2016-11-21 00:00:00',2),
('000005','Mold Press','Used to form and consolidate curds',3,10,3.3,4,'lb','2016-03-26 00:00:00','2016-04-26 00:00:00',3),
('000006','Raised Floor System','Provides an elevated structural floor above a solid substrate',9999.99,100,19999.98,1,'g','2015-07-15 00:00:00','2017-05-15 00:00:00',3),
('000007','Wirebonders','Interconnections between an integrated circuit (IC) or other semiconductor device',10,10,11,3,'lb','2016-04-18 00:00:00','2017-04-18 00:00:00',4),
('000008','Multifunctional Bond Testers','Semiconductor manufacturing equipment/material',3,10,3.3,3,'lb','2016-12-28 00:00:00','2017-12-28 00:00:00',4),
('000009','Test Handlers','Designed to perform in-circuit tests and functional tests on printed circuit boards',4,100,8,1,'lb','2016-01-18 00:00:00','2017-02-18 00:00:00',5),
('000010','Digital Flat Panel X-Ray','a class of solid-state x-ray digital radiography devices ',4,100,8,1,'lb','2016-02-18 00:00:00','2017-02-18 00:00:00',5),
('000011','Reed Relay','A type of relay that uses an electromagnet to control one or more reed switches',69.99,100,139.98,1,'g','2016-03-25 00:00:00','2017-03-25 00:00:00',6),
('000012','OEM Spare Replacement','Machine Tool OEM Parts',10,25,12.5,2,'lb','2016-04-23 00:00:00','2017-04-23 00:00:00',6),
('000013','Wafer Handling Tools','Handling Tools and Accessories for Wafer',30,100,60,4,'lb','2016-04-30 00:00:00','2017-05-31 00:00:00',7),
('000014','Embossed Tape and Reel Materials','Object around which lengths of another material (usually long and flexible) are wound for storage',4,100,8,1,'lb','2015-08-18 00:00:00','2016-08-18 00:00:00',7),
('000015','Industrial Cleaning Materials','Products that can be used for cleaning',4,100,8,1,'lb','2015-04-15 00:00:00','2016-04-15 00:00:00',8),
('000016','ESD and Clean Room Products','Products that can be used for cleaning',69.99,100,139.98,1,'g','2016-10-25 00:00:00','2017-10-25 00:00:00',9),
('000017','Extruded Carriers','Tool for transportation',10,20,12,3,'lb','2016-04-26 00:00:00','2016-04-30 00:00:00',9),
('000018','Corrugated Sheet','Suitable for any domestic, industrial or agricultural application',30,100,60,3,'lb','2016-04-05 00:00:00','2016-08-05 00:00:00',10),
('000019','Accessory of Corrugated Products','Other accessories for said product',4,100,8,1,'lb','2016-04-18 00:00:00','2017-04-18 00:00:00',10),
('000020','L-Style Holder','Tool for holding and storing',4,100,8,1,'lb','2016-05-18 00:00:00','2017-05-19 00:00:00',11),
('000021','Corrugated Box','Corrugated fiberboard boxes with the functional physical, processing and end-use requirements',100,35,135,1,'g','2016-01-18 00:00:00','2016-12-18 00:00:00',11),
('000022','ESD PDB Rack','Tool for holding and storing',100,25,125,2,'g','2016-04-18 00:00:00','2017-04-08 00:00:00',12),
('000023','Condor Sigma','Most advanced bond tester on the market',1234.75,15,1419.96,2,'g','2016-02-14 00:00:00','2016-07-14 00:00:00',12),
('000024','Magazine Rack','Tool for holding and storing',501,15,576.15,1,'lb','2015-04-18 00:00:00','2017-04-18 00:00:00',13),
('000025','Hang ESD PSB Racks','Tool for holding and storing',3,10,3.3,3,'lb','2015-11-05 00:00:00','2017-11-05 00:00:00',13);
...
('0905-001','2009-05-10 00:00:00','2009-05-20 00:00:00','Object around which lengths of another material (usually long and flexible) are wound for storage','0905-001','15 Days','FOB',89.9,100,189.9,7,7,1001),
('1002-001','2010-02-16 00:00:00','2010-02-28 00:00:00','Machine Tool OEM Parts','1002-001','COD','CIF',1077,100,1177,6,6,1002),
('1103-001','2011-03-27 00:00:00','2011-04-05 00:00:00','Interconnections between an integrated circuit (IC) or other semiconductor device','1103-001','30 Days','DAP',53.9,100,153.9,4,5,1003),
('1204-001','2012-04-07 00:00:00','2012-04-15 00:00:00','Provides an elevated structural floor above a solid substrate','1204-001','15 Days','FOB',200055.9,100,200155.9,3,4,1004),
('1304-001','2013-04-30 00:00:00','2013-05-10 00:00:00','Holds data as patterns of punched holes','1304-001','30 Days','DAP',12325.98,100,12425.98,2,3,1005),
('1504-001','2015-04-10 00:00:00','2015-04-17 00:00:00','Aluminum wire bonding','1504-001','15 Days','FOB',4250,200,4250,1,1,1006),
('1603-001','2016-03-17 00:00:00','2016-03-24 00:00:00','Designed to perform in-circuit tests and functional tests on printed circuit boards','1603-001','COD','CIF',160,100,260,5,8,1007);
...
('0608-001','2006-08-25 00:00:00','2006-08-25 00:00:00','2006-12-25 00:00:00','30 Days','DAP','REIC','Customer','REIC',24,10),
('0704-001','2007-04-05 00:00:00','2007-04-05 00:00:00','2007-07-05 00:00:00','15 Days','FOB','REIC','Customer','REIC',236,9),
('0804-001','2008-04-25 00:00:00','2008-04-25 00:00:00','2009-05-25 00:00:00','30 Days','DAP','REIC','Customer','REIC',783.9,8),
('0905-001','2009-05-05 00:00:00','2009-05-05 00:00:00','2010-07-15 00:00:00','15 Days','FOB','REIC','Customer','REIC',260,7),
('1002-001','2010-02-14 00:00:00','2010-02-14 00:00:00','2011-05-14 00:00:00','COD','CIF','REIC','Customer','REIC',787.4,6),
('1103-001','2011-03-25 00:00:00','2011-03-25 00:00:00','2012-03-25 00:00:00','30 Days','DAP','REIC','Customer','REIC',53.9,5),
('1204-001','2012-04-05 00:00:00','2012-04-05 00:00:00','2013-04-05 00:00:00','15 Days','FOB','REIC','Customer','REIC',200055.9,4),
('1304-001','2013-04-25 00:00:00','2013-04-25 00:00:00','2014-04-25 00:00:00','30 Days','DAP','REIC','Customer','REIC',12325.98,3),
('1504-001','2015-04-05 00:00:00','2015-04-05 00:00:00','2016-04-05 00:00:00','15 Days','FOB','REIC','Customer','REIC',4250,1),
('1603-001','2016-03-14 00:00:00','2016-03-14 00:00:00','2016-05-14 00:00:00','COD','CIF','REIC','Customer','REIC',160,8),
('1605-001','2016-05-15 00:00:00','2016-05-15 00:00:00','2017-05-15 00:00:00','15 Days','Ex-works','Customer','Customer','Supplier',19999.98,16);
...
('0608-001','2006-08-25 00:00:00','30 Days','DAP',10,10,'0608-001'),
('0704-001','2007-04-05 00:00:00','15 Days','FOB',9,9,'0704-001'),
('0804-001','2008-04-25 00:00:00','15 Days','DAP',8,8,'0804-001'),
('0905-001','2009-05-05 00:00:00','15 Days','FOB',7,7,'0905-001'),
('1002-001','2010-02-14 00:00:00','COD','CIF',6,6,'1002-001'),
('1103-001','2011-03-25 00:00:00','30 Days','DAP',5,4,'1103-001'),
('1204-001','2012-04-05 00:00:00','15 Days','FOB',4,3,'1204-001'),
('1304-001','2013-04-25 00:00:00','30 Days','DAP',3,2,'1304-001'),
('1504-001','2015-04-05 00:00:00','15 Days','FOB',1,1,'1504-001'),
('1603-001','2016-03-14 00:00:00','COD','CIF',8,5,'1603-001'),
('1605-001','2016-05-12 00:00:00','COD','Ex-works',4,13,NULL),
('1605-002','2016-05-12 00:00:00','60 Days','FOB',12,7,NULL),
('1605-003','2016-05-14 00:00:00','COD','DAP',11,7,NULL),
('1605-004','2016-05-14 00:00:00','COD','FOB',2,7,NULL),
('1605-005','2016-05-14 00:00:00','15 Days','Ex-works',9,6,NULL),
('1605-006','2016-05-14 00:00:00','30 Days','FOB',7,3,NULL),
('1605-007','2016-05-14 00:00:00','30 Days','DAP',13,5,NULL),
('1605-008','2016-05-14 00:00:00','30 Days','Ex-works',6,11,NULL),
('1605-009','2016-05-14 00:00:00','15 Days','FOB',10,10,NULL),
('1605-010','2016-05-14 00:00:00','30 Days','FOB',15,4,NULL),
('1605-011','2016-05-14 00:00:00','15 Days','Ex-works',3,12,NULL),
('1605-012','2016-05-14 00:00:00','15 Days','FOB',8,6,NULL),
('1605-013','2016-05-14 00:00:00','COD','CIF',13,12,NULL),
('1605-014','2016-05-14 00:00:00','15 Days','Ex-works',3,11,NULL),
('1605-015','2016-05-14 00:00:00','15 Days','CIF',1,13,NULL);
...
(1001,7,'2009-05-21 00:00:00','FOB','S09-00020061',2006,2006,220,0,26.4,220),
(1002,6,'2010-02-21 00:00:00','CIF','33400',2005,2005,724.9,0,86.99,724.9),
(1003,5,'2011-03-31 00:00:00','DAP','2011-03-004',2004,2004,53.9,0,6.47,53.9),
(1004,4,'2012-04-15 00:00:00','FOB','20042',2003,2003,40006.56,0,4800.79,40006.56),
(1005,3,'2013-05-06 00:00:00','DAP','130506012',2002,2002,4836.03,0,580.32,4836.03),
(1006,1,'2015-04-16 00:00:00','FOB','2015041603',2001,2001,645,0,77.4,645),
(1007,8,'2016-03-26 00:00:00','CIF','03262016-01',2000,2000,48,0,5.76,48);
