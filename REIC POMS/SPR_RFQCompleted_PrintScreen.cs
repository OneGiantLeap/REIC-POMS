...
namespace REIC_POMS
{
    public partial class SPR_RFQCompleted_PrintScreen : Form
    {
        ...
        private void SPR_RFQCompleted_PrintScreen_Load(object sender, EventArgs e)
        {
            ...
            //Data from rfq_t
            string selectPendingRFQ = "SELECT * FROM rfq_t WHERE pq_no IS NOT NULL;";
            ...
            string fileName = "C:\\REIC Files\\Report - Completed RFQ\\Completed RFQ (" + currentDateTime + ").pdf";
            rfqc.ExportToDisk(ExportFormatType.PortableDocFormat, fileName);
            MessageBox.Show("A PDF file of this report on completed requests for price quotation can be found in C:\\REIC Files\\Report - Completed RFQ.");
