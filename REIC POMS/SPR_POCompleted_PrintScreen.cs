...
namespace REIC_POMS
{
    public partial class SPR_POCompleted_PrintScreen : Form
    {
        //ATTRIBUTES
        ...
        //CONSTRUCTOR
        public SPR_POCompleted_PrintScreen()
        {
            InitializeComponent();
        ...
        private void SPR_POCompleted_PrintScreen_Load(object sender, EventArgs e)
        {
            ...
            //Data from PO Suppliers (Added DISTINCT for safety, I guess. To avoid ConstraintException)
            ...
            //Data from PO Customers (Added DISTINCT to avoid possible Constraint Exception)
            ...
            //Data from po_t
            string selectCompletedPO = "SELECT * FROM po_t WHERE so_no IS NOT NULL ORDER BY po_no DESC;";
            ...
            string filePath = "C:\\REIC Files\\Sales Performance Report & Summary\\Purchase Orders - Completed\\Completed PO (" + currentDateTime + ").pdf";
            poc.ExportToDisk(ExportFormatType.PortableDocFormat, filePath);

            MessageBox.Show("A PDF file of this report on completed purchase orders can be found in \n:\\REIC Files\\Sales Performance Report & Summary\\Purchase Orders - Completed.");
